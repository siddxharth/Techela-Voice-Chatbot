...
recognition.onresult = (event) => {
    ...
    if (transcript.toLowerCase().includes("events")) {
        ...
        $(".techfest-news").hide();
        $(".techfest-date").show();
    } else if(transcript.toLowerCase.includes("introduce")){
        let utterance = new SpeechSynthesisUtterance("Hi, I am Techfest Assistant. I can help you with the following commands: events, pre events, news, date, introduce");
        speechSynthesis.speak(utterance);
    }
}
